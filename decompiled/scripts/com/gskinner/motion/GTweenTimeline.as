package com.gskinner.motion
{
   public class GTweenTimeline extends GTween
   {
      ...
      override public function set position(param1:Number) : void
      {
         ...
         var _loc6_:int = int(this.tweens.length);
         if(_loc4_)
         {
            _loc5_ = 0;
            while(_loc5_ < _loc6_)
      ...
      public function addCallback(param1:*, param2:Function, param3:Array = null, param4:Function = null, param5:Array = null) : void
      {
         ...
         var _loc8_:int = int(this.callbacks.length);
      ...
      public function removeCallback(param1:*) : void
      {
         ...
         var _loc3_:int = int(this.callbacks.length);
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_)
         {
      ...
      public function calculateDuration() : void
      {
         ...
         {
            _loc1_ = Number(this.callbacks[this.callbacks.length - 1].position);
         }
         var _loc2_:int = 0;
      ...
      protected function checkCallbacks() : void
      {
         ...
         var _loc1_:uint = uint(_position / duration >> 0);
         var _loc2_:uint = uint(positionOld / duration >> 0);
         ...
         else
         {
            ...
            this.checkCallbackRange(calculatedPositionOld,_loc3_ ? 0 : duration);
            _loc3_ = reflect && _loc1_ % 2 >= 1;
            this.checkCallbackRange(_loc3_ ? duration : 0,calculatedPosition,!reflect);
         }
      }
      ...
      protected function checkCallbackRange(param1:Number, param2:Number, param3:Boolean = false) : void
      {
         ...
         var _loc6_:int = -1;
         var _loc7_:int = int(this.callbacks.length);
         var _loc8_:int = 1;
         if(param1 > param2)
         {
            _loc4_ = param2;
...
class Callback
{
   ...
   public function Callback(param1:Number, param2:Function, param3:Array, param4:Function, param5:Array)
   {
      super();
