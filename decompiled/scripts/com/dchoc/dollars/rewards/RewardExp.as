package com.dchoc.dollars.rewards
{
   ...
   public class RewardExp extends RewardSingle
   {
      
      public function RewardExp(param1:int = 0, param2:String = null)
      {
         super(param1,param2);
      }
