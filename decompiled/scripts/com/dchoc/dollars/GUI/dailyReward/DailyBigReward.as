package com.dchoc.dollars.GUI.dailyReward
{
   ...
   public class DailyBigReward extends Sprite
   {
      
      public static const CURRENT:uint = 0;
      ...
      public function DailyBigReward(param1:Number, param2:Number, param3:String = null)
      {
         super();
         this.mStatus = param2;
         switch(param2)
         {
            case CURRENT:
               ...
               this.mReward = new (DCResourceManager.getInstance().getSWFClass(Config.getRoot() + ModelConfig.DAILY_REWARD_SWF,"popup_box_dailyreward_special"))();
               addChild(this.mReward);
               this.mImage = new (DCResourceManager.getInstance().getSWFClass(Config.getRoot() + ModelConfig.DAILY_REWARD_SWF,"Daily_Reward_special_01"))();
               this.mImage.x = this.mImage.width + 10;
               this.mImage.y = this.mImage.height + 30;
               this.mImage.gotoAndStop(49);
               this.mReward.addChild(this.mImage);
               this.mButton = new DynamicButton(this.mReward.getChildByName("okButton") as MovieClip);
               break;
            case PENDING:
               this.mReward = new (DCResourceManager.getInstance().getSWFClass(Config.getRoot() + ModelConfig.DAILY_REWARD_SWF,"popup_box_dailyreward_special_lock"))();
               addChild(this.mReward);
               this.mImage = new (DCResourceManager.getInstance().getSWFClass(Config.getRoot() + ModelConfig.DAILY_REWARD_SWF,"Daily_Reward_special_01"))();
               this.mImage.x = this.mImage.width + 10;
               this.mImage.y = this.mImage.height + 30;
         ...
         this.mCaption = this.mReward.getChildByName("Caption") as TextField;
         TextManager.reformatTextField(this.mCaption);
         this.mCaption.text = TextManager.replaceParameters(TextIDs.TID_DAILY_BONUS_DAY,new Array("" + param1));
