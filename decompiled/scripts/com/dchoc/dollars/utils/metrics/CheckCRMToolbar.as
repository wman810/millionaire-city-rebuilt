package com.dchoc.dollars.utils.metrics
{
   ...
   public class CheckCRMToolbar extends CheckCRMURL
   {
      ...
      public static function getInstance() : CheckCRMToolbar
      {
         if(smInstance == null)
         {
            smAllowInstantiation = true;
            smInstance = new CheckCRMToolbar();
      ...
      override protected function checkStatus(param1:Event) : void
      {
         ...
         {
            Debug.trace("crm: " + _loc2_.data);
         }
         if(_loc2_.data == "1")
         {
            _loc3_ = MissionObjectManager.getInstance().getMissionBySku("87");
