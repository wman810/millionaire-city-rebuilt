package com.dchoc.dollars.utils.particles.climate
{
   ...
   public class Flake
   {
      ...
      public function Flake(param1:Number, param2:Number, param3:Map)
      {
         super();
         this.width = param1;
         this.height = param2;
         ...
         this.gravity = 1 + Math.random() * 2;
         this.wind = Math.random() * (1.4 * 2);
      ...
      public function logicUpdate(param1:int) : void
      {
         ...
         if(_loc4_ > 0 && _loc3_ > 0 && _loc4_ <= Dollars.smStage.stageHeight && _loc3_ <= Dollars.smStage.stageWidth && this.y >= 0 && this.x >= 0)
         {
            ...
            _loc5_.beginFill(_loc2_,this.alpha);
            _loc5_.drawCircle(this.x,this.y,this.size);
            _loc5_.endFill();
         }
      }
   }
