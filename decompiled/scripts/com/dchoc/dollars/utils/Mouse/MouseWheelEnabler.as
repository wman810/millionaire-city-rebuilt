package com.dchoc.dollars.utils.Mouse
{
   ...
   public class MouseWheelEnabler
   {
      ...
      public static function getBrowserInfo() : BrowserInfo
      {
         ...
         trace("not browserInfo");
         ExternalInterface.call("console.log","not browserInfo");
         return null;
      }
      ...
      private static function handleExternalMouseEvent(param1:Number, param2:*) : void
      {
         ...
         ExternalInterface.call("console.log","MouseWheelHandler");
         var _loc4_:uint = uint(getTimer());
         trace("handleExternalMouseEvent() --> curTime: " + _loc4_);
         ExternalInterface.call("console.log","curTime: " + _loc4_);
         var _loc5_:uint = eventTimeout + lastEventTime;
         trace("handleExternalMouseEvent() --> eventTimeout + lastEventTime: " + _loc5_);
         ExternalInterface.call("console.log","eventTimeout + lastEventTime: " + _loc5_);
         if(_loc4_ >= eventTimeout + lastEventTime)
         {
            trace("handleExternalMouseEvent() --> if: inside");
            ExternalInterface.call("console.log","if: inside");
            if(useRawValues)
            {
               _loc3_ = param1;
            }
            ...
            trace("handleExternalMouseEvent() --> currentItem: " + currentItem + ", browserMouseEvent: " + browserMouseEvent);
            ExternalInterface.call("console.log","currentItem: " + currentItem + ", browserMouseEvent: " + browserMouseEvent);
            if(Boolean(currentItem) && Boolean(browserMouseEvent))
            {
               trace("handleExternalMouseEvent() --> yeira!");
               ExternalInterface.call("console.log","MouseWheelHandler yeira!");
