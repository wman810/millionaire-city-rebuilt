package com.dchoc.dollars.world.items
{
   ...
   public class ItemDefinition extends Definition
   {
      ...
      public function getBuildObject(param1:String) : Sprite
      {
         ...
         {
            _loc3_ = DCResourceManager.getInstance().getSWFClass(this.getSkuToLoad(),param1 + "_new");
            if(_loc3_ == null)
            {
               _loc3_ = DCResourceManager.getInstance().getSWFClass(this.getSkuToLoad(),param1);
            }
      ...
      public function getIcon(param1:Sprite, param2:Boolean = false, param3:Boolean = false) : Object
      {
         ...
         var _loc5_:Class = DCResourceManager.getInstance().getSWFClass(_loc4_,"normal_new");
         if(_loc5_ == null)
         {
            _loc5_ = DCResourceManager.getInstance().getSWFClass(_loc4_,"normal");
         }
         ...
         while(_loc11_ < _loc10_.length)
         {
            ...
            do
            {
               _loc8_ = false;
               _loc7_ = null;
               _loc7_ = DCResourceManager.getInstance().getSWFClass(this.getSkuToLoad(),EFFECTS_NAME_PREFIX + _loc9_ + _loc10_[_loc11_] + "_new");
               if(_loc7_ == null)
               {
                  _loc7_ = DCResourceManager.getInstance().getSWFClass(this.getSkuToLoad(),EFFECTS_NAME_PREFIX + _loc9_ + _loc10_[_loc11_]);
               }
               _loc8_ ||= _loc7_ != null;
               if(_loc7_ != null)
               {
