      ...
      private function effectsDraw() : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            do
            {
               _loc2_ = false;
               _loc1_ = null;
               _loc1_ = DCResourceManager.getInstance().getSWFClass(this.itemDefinition.getSkuToLoad(),ItemDefinition.EFFECTS_NAME_PREFIX + _loc3_ + _loc4_[_loc5_] + "_new");
               if(_loc1_ == null)
               {
                  _loc1_ = DCResourceManager.getInstance().getSWFClass(this.itemDefinition.getSkuToLoad(),ItemDefinition.EFFECTS_NAME_PREFIX + _loc3_ + _loc4_[_loc5_]);
               }
               _loc2_ ||= _loc1_ != null;
               if(_loc1_ != null)
               {
